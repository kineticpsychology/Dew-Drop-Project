...
#ifndef _WAVENGINE_H_
#define _WAVENGINE_H_

#include "WaveOutEngine.h"

typedef class WAVENGINE : public WAVEOUTENGINE
{
    protected:
        BOOL            _bIs24Bit = FALSE;
        DWORD           _dwAvgBytesPerSec = 1; // Just to ensure it does not result in div/0 error
