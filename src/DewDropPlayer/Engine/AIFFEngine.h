...
#include "codecs/include/aiff/AIFFLib.h"

#ifdef _DEBUG
#pragma comment(lib, "./Engine/codecs/lib/debug/AIFFLib.lib")
#else
#pragma comment(lib, "./Engine/codecs/lib/release/AIFFLib.lib")
#endif

typedef class AIFFENGINE : public WAVEOUTENGINE
{
    protected:
        BOOL            _bAIFFLibInitialized = FALSE;
        LPBYTE          _lpDecodedChunk = NULL;
        DWORD           _dwTotalSamples = 0;
        WORD            _wBitsPerSample = 0;
