...
void DEWEXINFOBUTTON::_PrepareImages()
{
    Graphics        *pGr = NULL;
    RectF           rctPos;
...
void DEWEXINFOBUTTON::_MoveToDefaultLocation()
{
    float   fSeq = 3.0f;
    float   fGap;
...
DEWEXINFOBUTTON::DEWEXINFOBUTTON(LPDEWUIOBJECT Parent, const DEWTHEME& Theme)
{
    RECT    rctClient;

    _btObjectID = DEWUI_OBJ_EXINFO_BUTTON;
    _btObjectType = DEWUI_OBJ_TYPE_MMBUTTON;
    _Parent = Parent;
    StringCchPrintf(_wsText, DEWUI_MAX_TITLE, DEWUI_SYMBOL_EX_INFO);
    _iDPI = Theme.DPI;
    _fScale = Theme.Scale;
...
DEWEXINFOBUTTON::~DEWEXINFOBUTTON() {} // NOP
