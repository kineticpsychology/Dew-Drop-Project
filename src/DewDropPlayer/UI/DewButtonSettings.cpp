...
void DEWSETTINGSBUTTON::_PrepareImages()
{
    Graphics        *pGr = NULL;
    RectF           rctPos;
...
DEWSETTINGSBUTTON::DEWSETTINGSBUTTON(LPDEWUIOBJECT Parent, const DEWTHEME& Theme)
{
    RECT    rctClient;

    _btObjectID = DEWUI_OBJ_SETTINGS_BUTTON;
    _btObjectType = DEWUI_OBJ_TYPE_MMBUTTON;
    _Parent = Parent;
    StringCchPrintf(_wsText, DEWUI_MAX_TITLE, DEWUI_SYMBOL_SETTINGS);
    _iDPI = Theme.DPI;
    _fScale = Theme.Scale;
...
void DEWSETTINGSBUTTON::_MoveToDefaultLocation()
{
    float   fSeq = 4.0f;
    float   fGap;
...
DEWSETTINGSBUTTON::~DEWSETTINGSBUTTON() {} // NOP
