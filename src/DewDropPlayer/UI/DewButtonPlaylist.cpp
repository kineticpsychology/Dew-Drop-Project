...
void DEWPLAYLISTBUTTON::_PrepareImages()
{
    Graphics        *pGr = NULL;
    RectF           rctPos;
...
void DEWPLAYLISTBUTTON::_MoveToDefaultLocation()
{
    float   fSeq = 6.0f;
    float   fGap;
...
DEWPLAYLISTBUTTON::DEWPLAYLISTBUTTON(LPDEWUIOBJECT Parent, const DEWTHEME& Theme)
{
    RECT    rctClient;

    _btObjectID = DEWUI_OBJ_PLAYLIST_BUTTON;
    _btObjectType = DEWUI_OBJ_TYPE_MMBUTTON;
    _Parent = Parent;
    StringCchPrintf(_wsText, DEWUI_MAX_TITLE, DEWUI_SYMBOL_PLAYLIST);
    _iDPI = Theme.DPI;
    _fScale = Theme.Scale;
...
DEWPLAYLISTBUTTON::~DEWPLAYLISTBUTTON() {} // NOP
