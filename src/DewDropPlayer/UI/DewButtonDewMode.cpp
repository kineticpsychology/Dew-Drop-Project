...
void DEWDEWMODEBUTTON::_PrepareImages()
{
    Graphics        *pGr = NULL;
    RectF           rctPos;
...
void DEWDEWMODEBUTTON::_MoveToDefaultLocation()
{
    float   fSeq = 1.0f;
    float   fGap;
...
DEWDEWMODEBUTTON::DEWDEWMODEBUTTON(LPDEWUIOBJECT Parent, const DEWTHEME& Theme)
{
    RECT    rctClient;

    _btObjectID = DEWUI_OBJ_DEWMODE_BUTTON;
    _btObjectType = DEWUI_OBJ_TYPE_MMBUTTON;
    _Parent = Parent;
    StringCchPrintf(_wsText, DEWUI_MAX_TITLE, DEWUI_SYMBOL_DEW_MODE);
    _iDPI = Theme.DPI;
    _fScale = Theme.Scale;
...
DEWDEWMODEBUTTON::~DEWDEWMODEBUTTON() {} // NOP
